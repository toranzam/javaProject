...
public class ArrayCopy {
	...
	public static void main(String[] args) {
		...
		// a참조해서 수정함녀 b를 통해 접근시 수정 결과 확인됨
		int a[] = {1, 2, 3, 4};
		...
		// 2. Obejct.clone() -> Object를 모든 클래스는 상속받기때문에 배열객체에도 Object의 clone() 메소드가 있음
		int[] a2 = {1, 2, 3, 4};
		int[] b2 = a2.clone();
		...
		// 3. Arrays
		// Arrays.copyOf(원본배열, 복사길이) - 새로운 배열객체 생성 후 반환
		...
		System.out.println();
		System.out.println("Arrays.copyRange()이용한 깊은복사");
