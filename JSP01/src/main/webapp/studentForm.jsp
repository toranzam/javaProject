		 ...
		 <!-- 클래스의 필드명과 태그의 name 속성을 동일하게 구성 -->
	       ...
	       <tr>
	       	...
	       	<td>
	       		...
	       		<input type="checkbox" id="design" name="stdInterest" value="웹 프로그래밍"/>파이썬
	       		<input type="checkbox" id="digdata" name="stdInterest" value="웹 프로그래밍"/>빅데이터
	       		<input type="checkbox" id="java" name="stdInterest" value="웹 프로그래밍"/>java 프로그래밍
	       	</td>	
	       </tr>
	       <tr><td colspan="2">
